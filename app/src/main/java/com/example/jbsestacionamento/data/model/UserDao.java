...
import com.example.jbsestacionamento.AdminAreaActivity;
import com.example.jbsestacionamento.MainActivity;
            ...
            if (task.isSuccessful()) {
                if (!task.getResult().isEmpty()) {
                    ...
                    if (user != null && BCrypt.checkpw(password, user.getPassword())) {
                        ...
                        if (user.getAdmin()) {
                            Intent intent = new Intent(context, AdminAreaActivity.class);
                            context.startActivity(intent);
                        } else {
                            Intent intent = new Intent(context, MainActivity.class);
                            context.startActivity(intent);
